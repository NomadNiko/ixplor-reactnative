...
let authConfig = {};
const authConfigPath = join(__dirname, 'auth.config.js');
  ...
  expo: {
    ...
    plugins: [
      ...
      [
        "expo-location",
        {
          locationAlwaysAndWhenInUsePermission: "This app uses location to show nearby vendors and services on the map.",
          locationAlwaysPermission: "This app uses location to show nearby vendors and services on the map.",
          locationWhenInUsePermission: "This app uses location to show your position on the map and nearby vendors."
        }
      ],
    ...
    ios: {
      ...
      infoPlist: {
        ...
        NSLocationWhenInUseUsageDescription: "This app uses location to show your position on the map and nearby vendors.",
        NSLocationAlwaysAndWhenInUseUsageDescription: "This app uses location to show nearby vendors and services on the map.",
